...
void rseq_syscall_enter_work(long syscall)
{
	...
	/*
	 * Support onion layer applications which cannot guarantee that
	 * sched_yield(2) is used to yield the CPU for terminating a
	 * grant. This is a NOP on PREEMPT_FULL/LAZY because enabling
	 * preemption above already scheduled, but required for
